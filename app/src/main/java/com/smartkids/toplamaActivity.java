    ...
    public void clicksika (View view) {
        ...
        if (cevap.equals(num3)) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(toplamaActivity.this, WinAnimegifsActivity.class);
                    startActivity(i);
                }
            },1000);
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(toplamaActivity.this, LooseAnimeActivity.class);
                    startActivity(i);
                }
            },1000);
...
//
    ...
    public void cikis(View view) {
        //Intent i = new Intent(toplamaActivity.this,HomeActivity.class);startActivity(i);
        overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
        Intent myIntent = new Intent(toplamaActivity.this, HomeActivity.class);
        myIntent.putExtra("toplamasorusayisi", questioncounter);
        myIntent.putExtra("toplamadogrusayisi", dogrucounter);
        myIntent.putExtra("toplamayanlissayisi", yanliscounter);
        myIntent.putExtra("toplamabossayisi", boscounter);
