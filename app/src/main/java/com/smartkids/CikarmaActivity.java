...
public class CikarmaActivity extends Activity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        Integer b = random.nextInt(rangeup-rangedown+1)+rangedown;
        ...
        Integer sayi3 = sayi1 - sayi2;
        Integer sayi4 = sayi3+4;
        Integer sayi5 = sayi3-4;
        ...
        //Log.i("cevap",sayi3.toString());
        //Log.i(" rakam siklar",siklar.toString());

        //Log.i("rakam siklarshuffle",siklar.toString());
        //Log.i("8üstü",sayi4.toString());
        //Log.i("8alti",sayi5.toString());
...
//----------------------------
        ...
        //Log.i("rakam1",sayi1.toString()); Log.i("rakam2",sayi2.toString());  Log.i("rakam3",sayi3.toString());  Log.i("rakam4",siklar.toString());
    ...
    public void clicksika (View view) {
        ...
        if (cevap.equals(num3)) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(CikarmaActivity.this, WinAnimegifsActivity.class);
                    startActivity(i);
                }
            },1000);
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(CikarmaActivity.this, LooseAnimeActivity.class);
                    startActivity(i);
                }
            },1000);
...
//
    ...
    public void tamamla(View view) {
        ...
        if (cevapcounter >0) {
            ...
            animatorsoru.setObjectValues(0, cevapcounter);
...
//media player start
    ...
    public void cikis(View view) {
        Intent i = new Intent(CikarmaActivity.this,HomeActivity.class);startActivity(i);
        overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
        Intent myIntent = new Intent(CikarmaActivity.this, HomeActivity.class);
        myIntent.putExtra("cikarmasorusayisi", questioncounter);
        myIntent.putExtra("cikarmadogrusayisi", dogrucounter);
        myIntent.putExtra("cikarmayanlissayisi", yanliscounter);
        myIntent.putExtra("cikarmabossayisi", boscounter);
