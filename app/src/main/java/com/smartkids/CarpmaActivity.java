    ...
    public void clicksika (View view) {
        ...
        if (cevap.equals(num3)) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(CarpmaActivity.this, WinAnimegifsActivity.class);
                    startActivity(i);
                }
            },1000);
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent i = new Intent(CarpmaActivity.this, LooseAnimeActivity.class);
                    startActivity(i);
                }
            },1000);
...
//media player start
    ...
    public void cikis(View view) {
        Intent i = new Intent(CarpmaActivity.this,HomeActivity.class);startActivity(i);
        overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
        Intent myIntent = new Intent(CarpmaActivity.this, HomeActivity.class);
        myIntent.putExtra("carpmasorusayisi", questioncounter);
        myIntent.putExtra("carpmadogrusayisi", dogrucounter);
        myIntent.putExtra("carpmayanlissayisi", yanliscounter);
        myIntent.putExtra("carpmabossayisi", boscounter);
