...
public class CikarmaActivity extends Activity {
    ...
    int range1down,range1up,range2down,range2up;
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cikarmalayout);
        ...
        LinearLayout sonuclar = findViewById(R.id.sonuclarlayout);
        LinearLayout zorluk = findViewById(R.id.zorluklayout);
    ...
    public void soruhazirlama(){
        ...
        Integer a = random.nextInt(range1up-range1down+1)+range1down;
...
//----------------------------
    ...
    public void nextquestion(View view) {
        ...
        RelativeLayout sorugovde = findViewById(R.id.sorugovdelayout);
            sorugovde.startAnimation(AnimationUtils.loadAnimation(CikarmaActivity.this, R.anim.fadein_out));
    ...
    public void tamamla(View view) {
        ...
        if (cevapcounter >0) {
            ...
            Toast.makeText(CikarmaActivity.this,getString(R.string.toasthicsorucevaplamadın),Toast.LENGTH_SHORT).show();
        ...
        Integer intcikarmasoru,intcikarmadogru,intcikarmayanlis,intcikarmabos,intcikarmakumulatif;
        ...
        intcikarmakumulatif = sp.getInt("cikarmakumulatif",0);



        spEditor.putInt("cikarmasoru", (questioncounter+intcikarmasoru));
        spEditor.putInt("cikarmadogru",(dogrucounter+intcikarmadogru));
        spEditor.putInt("cikarmayanlis",(yanliscounter+intcikarmayanlis));
        spEditor.putInt("cikarmabos",(boscounter+intcikarmabos));
        spEditor.putInt("cikarmaleader",(scorecounter));
        spEditor.putInt("cikarmakumulatif",(scorecounter+intcikarmakumulatif));
        spEditor.commit();

        ////////////////////////SKOR BİLGİLERİ BİTTİ////////////////////////

       // Intent myIntent = new Intent(CikarmaActivity.this, MainmenuActivity.class);
      //  myIntent.putExtra("cikarmascore", scorecounter);
    ...
    public void cikis(View view) {
        ...
        Intent i = new Intent(CikarmaActivity.this,TrainingActivity.class);startActivity(i);
    ...
    public void onBackPressed() {
        ...
        if (sorugovde.getVisibility()==View.VISIBLE){
            Toast.makeText(CikarmaActivity.this,getString(R.string.quittoast),Toast.LENGTH_SHORT).show();
        }
        if (zorluk.getVisibility()==View.VISIBLE){
            Intent myIntent = new Intent(CikarmaActivity.this, TrainingActivity.class);
            startActivity(myIntent);
