...
public class KonularPagerAdapter extends androidx.viewpager.widget.PagerAdapter {
    ...
    public KonularPagerAdapter(Context context, List<SmartGames> smartGames) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (layoutInflater != null) {
            view = layoutInflater.inflate(R.layout.item_main_pager,container,false);
        }
